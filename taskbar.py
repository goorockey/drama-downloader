...
class Taskbar(object):
    ...
    def onRightClick(self):
        ...
        win32gui.AppendMenu(menu, win32con.MF_STRING, WM_TASKBARNOTIFY_MENUITEM_SHOW, u'Display')
        win32gui.AppendMenu(menu, win32con.MF_STRING, WM_TASKBARNOTIFY_MENUITEM_HIDE, u'Hide')
        win32gui.AppendMenu(menu, win32con.MF_STRING, WM_TASKBARNOTIFY_MENUITEM_EXIT, u'Exit')
...
if __name__=='__main__':
    ...
    t = Taskbar('drama_download.exe -d ', 'Drama downloader (by goorockey)')
